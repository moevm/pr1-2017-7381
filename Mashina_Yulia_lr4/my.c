...
{
        MusicalComposition* for_push = (MusicalComposition*)malloc(sizeof(MusicalComposition));
        for_push->name = (char*)malloc(sizeof(char)*81);
        for_push->author = (char*)malloc(sizeof(char)*81);
        strcpy(for_push->name, name);
        strcpy(for_push->author,author);
        for_push->year = year;
        for_push->next = NULL;
        for_push->prev = NULL;
        return for_push;
